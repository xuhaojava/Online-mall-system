...
import com.xh.server.model.ItemExample.Criteria;
import com.xh.server.model.ItemExample.Criterion;
import com.xh.server.model.ItemExample;
...
public class ItemSqlProvider {
    ...
    public String insertSelective(Item record) {
        ...
        if (record.getListprice() != null) {
            sql.VALUES("listprice", "#{listprice,jdbcType=REAL}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getListprice() != null) {
            sql.SET("listprice = #{record.listprice,jdbcType=REAL}");
        }
    ...
    public String updateByPrimaryKeySelective(Item record) {
        ...
        if (record.getListprice() != null) {
            sql.SET("listprice = #{listprice,jdbcType=REAL}");
        }
